					...
					<div class="blog-inner-details-page">
						...
						<div class="comment-respond-box">
							...
							<div class="comment-respond-form">
								<form id="commentrespondform" class="comment-form-respond row" action="comments_backend.php" method="post">
				...
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-8 col-12 blog-sidebar">
					<div class="right-side-blog">
						...
						<div class="blog-categories">
							<ul>
								<li><a href="chicken-recipes.php"><span>Chicken</span></a></li>
								<li><a href="mutton-recipes.php"><span>Mutton</span></a></li>
								<li><a href="fish-recipes.php"><span>Fish</span></a></li>
								<li><a href="north-indian-recipes.php"><span>North Indian</span></a></li>
								<li><a href="south-indian-recipes.php"><span>South Indian</span></a></li>
								<li><a href="middle-eastern-recipes.php"><span>Middle Eastern</span></a></li>
								<li><a href="italian-recipes.php"><span>Italian</span></a></li>
								<li><a href="chinese-recipes.php"><span>Chinese</span></a></li>
								<li><a href="soft-drinks.php"><span>Soft Drinks</span></a></li>
								<li><a href="tea-coffee.php"><span>Tea / Coffee</span></a></li>
							</ul>
						</div>
					</div>
				</div>
