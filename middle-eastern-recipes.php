		...
		<div class="container">
			...
			<div class="row">
				...
				<?php
					...
					$sqlr1 = "SELECT * FROM recipes_1,recipes_2 where category='Middle Eastern Recipes' and recipes_1.id=r1_id";
