			...
			<div class="row">
              ...
              <p>
                ...
                <strong>Prep Time :</strong> <?php echo $rsr1['prep_time']; ?>&nbsp;m
							...
							<a href="recipe-details.php?item=<?php echo $rsr1['r1_id'];  ?>"><button  class="btn btn-lg btn-circle btn-outline-new-white" type="submit" name="submitbtn">READ MORE</button></a>
						</div>
					</div>
				</div>
			<?php  }?>
